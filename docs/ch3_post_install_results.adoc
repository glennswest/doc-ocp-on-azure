...
At this point the infrastructure and Red Hat OpenShift Container Platform have been deployed. Log into the _Azure_ console and check the resources. In the _Azure_ console, check for the following resources:
