...
IMPORTANT: Due to the current *{ma}* limitations on subdomains, the default wildcard entry uses the nip.io service. This can be modified after the installation and it is explained in the <<ch2_dns.adoc,Microsoft Azure DNS>> section
